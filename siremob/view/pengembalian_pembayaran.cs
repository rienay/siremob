...
namespace siremob.view
{
    public partial class pengembalian_pembayaran : Form
    {
        ...
        private void ResetForm()
        {
            ...
            txt_idpengembalian.ReadOnly = true;
            ...
            txt_denda_kerusakan.ReadOnly = true;

            txt_total_bayar.Text = "0";
            txt_total_bayar.ReadOnly = true;

            cmb_kondisimobil.Items.Clear();
            ...
            cmb_ststus_pembayaran.Items.Clear();
        ...
        private void HitungKeterlambatanDanDenda()
        {
            ...
            // 4. Ambil Nilai Total Biaya Sewa Estimasi
            ...
            // 5. Hitung Total Bayar Keseluruhan
